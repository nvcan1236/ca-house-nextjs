...
import { facilities, furnitures, motelTypes, services } from '@/lib/predefined-data';
import { applyFilter, refreshFilter, updateAmenity, updateMotelType, updatePrice } from '@/stores/slices/filterSlice';
